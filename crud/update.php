...
$resultat = $bdd->query('SELECT * FROM clients WHERE lastName="Perry"');
        ...
        if (isset($_POST['button'])) {
            ...
            $data = [
                ...
                try
                {
                    ...
                    $update =$bdd->prepare('UPDATE clients SET lastName=:lastName, firstName=:firstName, birthDate=:birthDate, card=:card, cardNumber=:cardNumber WHERE lastName=:lastName ');
