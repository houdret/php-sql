    ...
    <body>
        ...
        <form action="" method="post" class=" was-validated row g-1 ">
            ...
            <div class="input-group-text">
                <input class="form-check-input mt-0" type="checkbox" value="" aria-label="Checkbox for following text input" name="checked">
            </div>
            <?php while ($donnees = $resultat->fetch())
                {
                    echo '<input class="form-check-input mt-0" type="checkbox" value="" aria-label="Checkbox for following text input" name="checked">';
                    echo '<input type="text" class="form-control" aria-label="Text input with checkbox" value="'.$donnees['ville'].'" aria-label="Checkbox for following text input">';
        ...
        if (isset($_POST['submit'])) {
            ...
            {
                $insertion =
                'INSERT INTO météo (ville, haut, bas ) VALUES (:ville,:haut,:bas)';
